...
export default async function Page({ params}:{ params: { serial: string }}) {
  ...
  return (
    <main className="flex-1 space-y-8">
        <h1 className="px-4 py-2 text-lg md:text-4xl text-center font-bold tracking-wider rounded border-2 border-[#153B50] text-[#153B50]">GRASAG/JCRC ELECTIONS NOMINATION FORM</h1>
        <div className="p-4 md:px-10 md:py-6 rounded shadow shadow-red-300/50 bg-red-50/80 space-y-4">
          <h2 className="text-lg md:text-xl">INSTRUCTIONS { params.serial }</h2>
