  ...
  return (
    <aside className="w-full md:m-0 md:w-48 print:hidden">
        <nav className="grid grid-col-1 border rounded overflow-hidden shadow-lg shadow-gray-200/30 divide-y divide-slate-200 text-[#153B50] text-xs tracking-widest">
          <Link href={`/vouchers`} className={ pathname == `/vouchers` ? `p-2 px-6 md:py-4 font-semibold text-white bg-[#153B50]` : `p-2 px-6 md:py-4 font-semibold bg-slate-50`}>VOUCHERS</Link>
          <Link href={`/nominees`} className={ pathname == `/nominees` ? `p-2 px-6 md:py-4 font-semibold text-white bg-[#153B50]` : `p-2 px-6 md:py-4 font-semibold bg-slate-50`}>NOMINEES</Link>
          <Link href={`/display`} className={ pathname == `/display` ? `p-2 px-6 md:py-4 font-semibold text-white bg-[#153B50]` : `p-2 px-6 md:py-4 font-semibold bg-slate-50`}>DISPLAY</Link>
