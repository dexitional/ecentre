  ...
  return (
    <div className="w-full h-80 bg-red-200 bg-[url('../public/bg3.jpg')] bg-center">
        <div className="mx-auto h-full w-full md:max-w-6xl grid place-content-center">
            {/* @ts-ignore */}
            <form action={validateVoucher} className="px-10 py-6 mx-auto w-full rounded-lg shadow-xl border-2 md:border-4 border-white/70 backdrop-blur-sm bg-opacity-60 bg-blue-950 grid place-content-center gap-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-3 md:gap-y-0 gap-x-3 font-semibold">
                   <input name="serial" defaultValue="" className="px-6 py-3 rounded-lg text-white placeholder:tracking-[0.2em] placeholder:text-white bg-blue-950/70 border-2 focus:ring-0 focus:border-white border-white col-span-1" type="text" placeholder="SERIAL" />
                   <input name="pin"  defaultValue="" className="px-6 py-3 rounded-lg text-white placeholder:tracking-[0.2em] placeholder:text-white bg-blue-950/70 border-2 focus:ring-0 focus:border-white border-white col-span-1" type="text" placeholder="PIN" />
                </div>
