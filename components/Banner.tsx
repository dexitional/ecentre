    ...
    <div className="w-full h-80 bg-red-200 bg-[url('../public/bg3.jpg')] bg-center">
        <div className="mx-auto h-full w-full md:max-w-6xl grid place-content-center">
            ...
            <form onSubmit={authenticate} className="px-10 py-6 mx-auto w-full rounded-2xl shadow-xl border-2 md:border-4 border-white/70 backdrop-blur-sm bg-opacity-60 bg-blue-950 grid place-content-center gap-y-4">
                ...
                <button type="submit" disabled className="px-6 py-2 h-10 md:h-14 min-w-md rounded-lg bg-slate-100 border-b border-blue-950 text-blue-950 font-semibold flex items-center justify-center space-x-4">
                    { status == 'loading' ?
                      <>
                ...
                <button type="button" disabled onClick={adminSignin} className="px-6 py-2 h-10 md:h-14 min-w-md rounded-lg bg-yellow-100 border-b border-blue-950 text-blue-950 font-semibold flex items-center justify-center space-x-4">
