  ...
  return (
    <div className="z-1 relative w-full h-96 overflow-hidden">
        ...
        <div className="z-30 px-10 py-6 h-full w-full flex flex-col items-center justify-center space-y-6 text-white">
          <h1 className="z-40 text-3xl font-roboto font-extrabold border-white bg-gradient-to-r from-yellow-400 via-yellow-600 to-yellow-400 bg-clip-text text-transparent">2023 Election Instructions</h1>
          <span className="z-40 leading-6 text-xl text-center">Not sure what your role is in this elections. Head here to find out what to do.</span>
          <button className="px-6 py-3 z-40 min-w-max bg-yellow-400 text-[#153b50] flex items-center space-x-4 text-sm font-medium font-roboto">
