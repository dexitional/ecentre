  ...
  return (
    <div className="w-full">
        <header className="relative h-24 bg-red-800 flex items-center rounded-md">
            ...
            <h2 className="z-20 px-6 py-3 w-4/5 h-14 flex items-center justify-center rounded-tl-full rounded-bl-full bg-blue-950 text-blue-50 text-3xl print:text-2xl font-bold tracking-widest absolute top-16 left-[50%] -translate-x-[50%] ">{group?.title?.toUpperCase()} ELECTIONS</h2>
