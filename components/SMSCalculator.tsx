    ...
    <form className="p-4 w-48 flex flex-col">
        <div className="rounded bg-slate-50 shadow-xl shadow-slate-200 overflow-hidden flex flex-col space-y-2">
            ...
            <div className="px-4 py-4 space-y-2">
               <p className="relative px-2 py-1 font-mono font-semibold text-sm">SMS RATE <sub className="z-10 absolute bottom-0 right-2 p-1 bg-orange-50 rounded block">Per SMS</sub><span className="p-0.5 block rounded bg-blue-50  text-center text-lg font-bold italic tracking-wider">0.04</span></p>
